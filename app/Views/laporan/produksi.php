...
<div class="page-header">
    ...
    <div class="header-actions-group" style="display: flex; gap: 10px;">
        <button class="btn-secondary" onclick="exportToExcel('Laporan_Produksi')" style="background: #198754; color: white; border-color: #198754; display: flex; align-items: center; gap: 6px;">
            <i class="fa-solid fa-file-excel"></i> Export Excel
        </button>
        <button class="btn-secondary" onclick="exportToPDF('Laporan Produksi')" style="background: #dc3545; color: white; border-color: #dc3545; display: flex; align-items: center; gap: 6px;">
